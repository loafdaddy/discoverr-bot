...
- [x] Publish **v2.0.0**–**v3.3.2** on GitHub
...
## v3.3.2 (`release/3.3.2`)

- [x] Hidden gem cutoff follows `TZ`, not the host clock ([#10](https://github.com/loafdaddy/discoverr-bot/pull/10))
- [x] Cut **v3.3.2** release / tag / GHCR publish
